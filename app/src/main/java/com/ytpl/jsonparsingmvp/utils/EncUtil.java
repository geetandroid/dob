...
//https://github.com/martinraj/encrypt-decrypt-android-demo
...
public class EncUtil {
    ...
    public static String encryptM(Context context, String input){
        Cipher c = null;
        try {
    ...
    @RequiresApi(api = Build.VERSION_CODES.KITKAT)
    public static byte[] decryptM(Context context, String encrypted){
        Cipher c = null;
        try {
            c = Cipher.getInstance(AES_MODE);
